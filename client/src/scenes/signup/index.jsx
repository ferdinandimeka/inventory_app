                ...
                >
                    ...
                    <Box>
                        <form onSubmit={formik.handleSubmit}>
                            ...
                            >
                                ...
                                >
                                    ...
                                    />
                                    <FormHelperText id="my-helper-text">{formik.errors.name}</FormHelperText>
                                </FormControl>
                        ...
                        <Typography
                            ml="1rem"
                            mt='0.5rem'
                        >Already have an account? <span style={{color: theme.palette.secondary[500],
                        cursor: 'pointer'}} onClick={() => {clickHandler('/login')}}>Log in</span>
                        </Typography>
                    </Box>
